...
UPDATE `Elnokrashyospos_app_config`
...
RENAME TABLE `Elnokrashyospos_tax_codes` TO `Elnokrashyospos_tax_codes_backup`;
...
RENAME TABLE `Elnokrashyospos_sales_taxes` TO `Elnokrashyospos_sales_taxes_backup`;
...
CREATE TABLE IF NOT EXISTS `Elnokrashyospos_tax_jurisdictions` (
...
RENAME TABLE `Elnokrashyospos_tax_code_rates` TO `Elnokrashyospos_tax_code_rates_backup`;

CREATE TABLE IF NOT EXISTS `Elnokrashyospos_tax_rates` (
