...
-- Table structure for table `Elnokrashyospos_cash_up`

CREATE TABLE `Elnokrashyospos_cash_up` (
...
-- Indexes for table `Elnokrashyospos_cash_up`

ALTER TABLE `Elnokrashyospos_cash_up`
  ADD PRIMARY KEY (`cashup_id`),
  ADD KEY `open_employee_id` (`open_employee_id`),
  ADD KEY `close_employee_id` (`close_employee_id`),
  ADD CONSTRAINT `Elnokrashyospos_cash_up_ibfk_1` FOREIGN KEY (`open_employee_id`) REFERENCES `Elnokrashyospos_employees` (`person_id`),
  ADD CONSTRAINT `Elnokrashyospos_cash_up_ibfk_2` FOREIGN KEY (`close_employee_id`) REFERENCES `Elnokrashyospos_employees` (`person_id`);

-- AUTO_INCREMENT for table `Elnokrashyospos_cash_up`
...
ALTER TABLE Elnokrashyospos_cash_up CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;
ALTER TABLE Elnokrashyospos_expense_categories CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;
ALTER TABLE Elnokrashyospos_expenses CONVERT TO CHARACTER SET utf8 COLLATE utf8_general_ci;
...
UPDATE `Elnokrashyospos_expenses`
  INNER JOIN `Elnokrashyospos_suppliers`
    ON `Elnokrashyospos_expenses`.`supplier_name` = `Elnokrashyospos_suppliers`.`company_name`
SET `Elnokrashyospos_expenses`.`supplier_id` = `Elnokrashyospos_suppliers`.`person_id`;
...
ALTER TABLE `Elnokrashyospos_expenses`
  ADD CONSTRAINT `Elnokrashyospos_expenses_ibfk_3` FOREIGN KEY (`supplier_id`) REFERENCES `Elnokrashyospos_suppliers` (`person_id`);
