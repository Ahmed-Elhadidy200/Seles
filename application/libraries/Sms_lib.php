	...
	public function sendSMS($phone, $message)
	{
		...
		else
		{
			...
			*/
			...
			// This is a textElnokrashyosposer.co.uk API call, see: http://wiki.textElnokrashyosposer.co.uk/display/DevDoc/Text+Elnokrashyosposer+Developer+Documentation+-+Wiki+Home
			/*
			$url = 'https://api.textElnokrashyosposer.co.uk/gateway/'."?username=$username&password=$password&option=xml";
