...
class Config extends Secure_Controller
{
	...
	/*
	 * This function loads all the licenses starting with the first one being Elnokrashyospos one
	 */
	private function _licenses()
	{
		...
		{
			$license[$i]['text'] = 'LICENSE file must be in Elnokrashyospos license directory. You are not allowed to use Elnokrashyospos application until the distribution copy of LICENSE file is present.';
		}
	...
	public function save_general()
	{
		...
		{
			$definition_data['definition_name'] = 'Elnokrashyospos_category';
	...
	public function backup_db()
	{
		...
		if($this->Employee->has_module_grant('config', $employee_id))
		{
			...
			$prefs = array(
				'format' => 'zip',
				'filename' => 'Elnokrashyospos.sql'
			);

			$backup = $this->dbutil->backup($prefs);

			$file_name = 'Elnokrashyospos-' . date("Y-m-d-H-i-s") .'.zip';
