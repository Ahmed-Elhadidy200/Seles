...
/* 
|-------------------------------------------------------------------------- 
| Internal to Elnokrashyospos XSS Clean 
|-------------------------------------------------------------------------- 
| 
...
| 
*/ 
$config['Elnokrashyospos_xss_clean'] = TRUE;
...
|
*/
$config['encryption_key'] = getenv('ENCRYPTION_KEY') ? getenv('ENCRYPTION_KEY') : '3743e605d13b546de2da934625726ef3afaaad5dd0193807bfdf3ba0fca36550';
...
$config['sess_cookie_name'] = 'Elnokrashyospos_session';
...
$config['csrf_token_name'] = 'csrf_Elnokrashyospos_v3';
$config['csrf_cookie_name'] = 'csrf_cookie_Elnokrashyospos_v3';
