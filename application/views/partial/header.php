...
<head>
	...
	<?php if ($this->input->cookie('debug') == 'true' || $this->input->get('debug') == 'true') : ?>
		...
		<link rel="stylesheet" type="text/css" href="css/Elnokrashyospos_print.css"/>
		<link rel="stylesheet" type="text/css" href="css/Elnokrashyospos.css"/>
	...
	<?php } ?>
		...
		<script type="text/javascript" src="dist/opensourcepos.min.js?rel=09f395beea"></script>
	...
	<style type="text/css">
		...
		.navbar-default{
            ...
            -moz-box-shadow:0px 1px 10px grey;
		...
		body > div > div.navbar.navbar-default > div{
		        display: flex;
		...
		.navbar-right a{
		    color:#0e6500 !important;
		}
		#home_module_list div a{
		    color:#073d62 !important;
		    font-size: 16px;
		    padding-top:10px;
		}
		...
		#home_module_list :hover{
			color: #e56300 !important;
		}
		.navbar-right .modal-dlg,body > div > div.topbar > div > div.navbar-right > a:nth-child(2){
		    color : white !important;
		}
		.navbar-right .modal-dlg:hover,body > div > div.topbar > div > div.navbar-right > a:nth-child(2):hover{
		    color: #ffd660 !important;
		}
		#sales_takings_button,#show_sales_button{
		    color:white !important;
		}
		#overall_sale,#add_item_form,#mode_form,#payment_details{
		...
		<div class="navbar navbar-default" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<!--<a class="navbar-brand hidden-sm text-center" href="<?php echo site_url(); ?>">Robobox Sales System</a>-->
					  <div class="site-identity">
            <a href="<?php echo site_url(); ?>"><h3>الصفحة الرئيسية</h3></a>
            </div>
				</div>
